...
import cayyoluBefore from "@/assets/projects/cayyolu-before.jpg";
import cayyoluAfter from "@/assets/projects/cayyolu-after.jpg";
import etimesgutBefore from "@/assets/projects/etimesgut-before.jpg";
import etimesgutAfter from "@/assets/projects/etimesgut-after.jpg";
...
function CompareCard({
  ...
  return (
    <article className="overflow-hidden rounded-3xl border border-border bg-card shadow-premium">
      ...
      >
        <img src={after} alt={`${location} — sonrası`} className="absolute inset-0 h-full w-full object-cover" />
