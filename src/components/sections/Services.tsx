...
const items = [
  ...
  { t: "Wintent — Zip Perde", d: "Cam yüzey, ray ve fermuar sistemlerinde yüksek basınçlı profesyonel temizlik." },
  { t: "Kepenk — Panjur", d: "Lamel arası tortu, oksit ve nem temizliği; yağlama ve sessizleştirme." },
